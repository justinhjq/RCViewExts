...
import ttyy.com.recyclerexts.tags.TagsHorizontalLayoutManager;
import ttyy.com.recyclerexts.tags.TagsVerticalLayoutManager;

public class TagsHorizontalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tags_horizontal);

        recycler_view = (RecyclerView) findViewById(R.id.recycler_view);

        recycler_view.setLayoutManager(new TagsHorizontalLayoutManager());
